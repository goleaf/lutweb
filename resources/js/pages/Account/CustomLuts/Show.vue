    ...
    <AccountLayout :title="purchase.name">
        <section class="space-y-5">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <span
                    v-else
                    class="rounded-md border border-stone-200 bg-stone-50 px-4 py-2.5 text-sm text-stone-600"
                >
                ...
                <Link
                    ...
                    class="rounded-md border border-stone-300 bg-white px-4 py-2.5 text-sm font-medium text-stone-800 hover:bg-stone-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-700"
                >
                    View Order
                </Link>
                <Link
