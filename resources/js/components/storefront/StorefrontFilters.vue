...
<template>
    ...
    >
        <div class="flex items-center justify-between gap-3">
            <h2 class="text-base font-semibold text-stone-950">Filters</h2>
            <button
                type="button"
                class="rounded-md px-2 py-1 text-sm font-semibold text-teal-800 underline-offset-4 hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-700"
                @click="emit('reset')"
            >
                Reset filters
            </button>
        ...
        <div class="mt-4 grid gap-4">
            ...
            >
                <p class="font-medium text-stone-950">Category</p>
        ...
        <p class="mt-4 text-sm text-stone-500" aria-live="polite" role="status">
